...
/* ****************************************************************************/
#[inline]
pub unsafe fn scale_expansion_zeroelim(
    mut elen: i32,
    mut e: *const f64,
    mut b: f64,
    mut h: *mut f64,
...
/* ****************************************************************************/
#[inline]
pub unsafe fn compress(mut elen: i32, mut e: *const f64, mut h: *mut f64) -> i32 {
    let mut Q: f64 = 0.;
    let mut q: f64 = 0.;
    let mut Qnew: f64 = 0.;
    let mut eindex: i32 = 0;
...
/* ****************************************************************************/
#[inline]
pub unsafe fn estimate(mut elen: i32, mut e: *const f64) -> f64 {
    let mut Q: f64 = 0.;
    let mut eindex: i32 = 0;
...
pub unsafe fn incircleadapt(
    ...
    if adxtail != 0.0f64 {
        axtbclen =
            scale_expansion_zeroelim(4 as i32, bc.as_mut_ptr(), adxtail, axtbc.as_mut_ptr());
        ...
        axtcclen =
            scale_expansion_zeroelim(4 as i32, cc.as_mut_ptr(), adxtail, axtcc.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(axtcclen, axtcc.as_mut_ptr(), bdy, temp16b.as_mut_ptr());
        axtbblen =
            scale_expansion_zeroelim(4 as i32, bb.as_mut_ptr(), adxtail, axtbb.as_mut_ptr());
        temp16clen =
    ...
    if adytail != 0.0f64 {
        aytbclen =
            scale_expansion_zeroelim(4 as i32, bc.as_mut_ptr(), adytail, aytbc.as_mut_ptr());
        temp16alen = scale_expansion_zeroelim(
            aytbclen,
            aytbc.as_mut_ptr(),
            2.0f64 * ady,
        ...
        aytbblen =
            scale_expansion_zeroelim(4 as i32, bb.as_mut_ptr(), adytail, aytbb.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(aytbblen, aytbb.as_mut_ptr(), cdx, temp16b.as_mut_ptr());
        aytcclen =
            scale_expansion_zeroelim(4 as i32, cc.as_mut_ptr(), adytail, aytcc.as_mut_ptr());
        temp16clen =
    ...
    if bdxtail != 0.0f64 {
        bxtcalen =
            scale_expansion_zeroelim(4 as i32, ca.as_mut_ptr(), bdxtail, bxtca.as_mut_ptr());
        temp16alen = scale_expansion_zeroelim(
            bxtcalen,
            bxtca.as_mut_ptr(),
            2.0f64 * bdx,
        ...
        bxtaalen =
            scale_expansion_zeroelim(4 as i32, aa.as_mut_ptr(), bdxtail, bxtaa.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(bxtaalen, bxtaa.as_mut_ptr(), cdy, temp16b.as_mut_ptr());
        bxtcclen =
            scale_expansion_zeroelim(4 as i32, cc.as_mut_ptr(), bdxtail, bxtcc.as_mut_ptr());
        temp16clen =
    ...
    if bdytail != 0.0f64 {
        bytcalen =
            scale_expansion_zeroelim(4 as i32, ca.as_mut_ptr(), bdytail, bytca.as_mut_ptr());
        temp16alen = scale_expansion_zeroelim(
            bytcalen,
            bytca.as_mut_ptr(),
            2.0f64 * bdy,
        ...
        bytcclen =
            scale_expansion_zeroelim(4 as i32, cc.as_mut_ptr(), bdytail, bytcc.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(bytcclen, bytcc.as_mut_ptr(), adx, temp16b.as_mut_ptr());
        bytaalen =
            scale_expansion_zeroelim(4 as i32, aa.as_mut_ptr(), bdytail, bytaa.as_mut_ptr());
        temp16clen =
    ...
    if cdxtail != 0.0f64 {
        cxtablen =
            scale_expansion_zeroelim(4 as i32, ab.as_mut_ptr(), cdxtail, cxtab.as_mut_ptr());
        temp16alen = scale_expansion_zeroelim(
            cxtablen,
            cxtab.as_mut_ptr(),
            2.0f64 * cdx,
        ...
        cxtbblen =
            scale_expansion_zeroelim(4 as i32, bb.as_mut_ptr(), cdxtail, cxtbb.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(cxtbblen, cxtbb.as_mut_ptr(), ady, temp16b.as_mut_ptr());
        cxtaalen =
            scale_expansion_zeroelim(4 as i32, aa.as_mut_ptr(), cdxtail, cxtaa.as_mut_ptr());
        temp16clen =
    ...
    if cdytail != 0.0f64 {
        cytablen =
            scale_expansion_zeroelim(4 as i32, ab.as_mut_ptr(), cdytail, cytab.as_mut_ptr());
        temp16alen = scale_expansion_zeroelim(
            cytablen,
            cytab.as_mut_ptr(),
            2.0f64 * cdy,
        ...
        cytaalen =
            scale_expansion_zeroelim(4 as i32, aa.as_mut_ptr(), cdytail, cytaa.as_mut_ptr());
        temp16blen =
            scale_expansion_zeroelim(cytaalen, cytaa.as_mut_ptr(), bdx, temp16b.as_mut_ptr());
        cytbblen =
            scale_expansion_zeroelim(4 as i32, bb.as_mut_ptr(), cdytail, cytbb.as_mut_ptr());
        temp16clen =
